...
date_format1 = "%Y-%m"
date_format2 = "%Y_%m"
save_date = datetime.strftime(date, date_format2)
start_of_day_o = datetime.strftime(date, date_format1)
end_of_today = datetime.strftime(date, date_format)
start_of_day = start_of_day_o +"-01"+ " 00:00:00"
print(start_of_day)
print(end_of_today)
...
#save 
df.to_csv("./data_3000/"+save_date+".csv")
...
pickle.dump(vectorizer, open("./data_3000/" + save_date + "_vectorizer.pickle", "wb"))
pickle.dump(X, open("./data_3000/" + save_date + ".pickle", "wb"))
